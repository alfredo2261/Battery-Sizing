...
if load is not None:
    ...
    growth_rate = st.number_input("Enter the annual load growth rate (from 0-1): ", value = 0.0, step=0.001, format="%0.3f")
    degradation = st.number_input("Enter the annual degradation rate (from 0-1): ", value = 0.0, step=0.001, format="%0.3f")
    dod = st.number_input("Enter the depth of discharge of the battery (from 0-1): ", value = 0.0, step=0.001, format="%0.3f")
    rte = st.number_input("Enter the round-trip efficiency of the battery (from 0-1): ", value = 0.0, step=0.001, format="%0.3f")
